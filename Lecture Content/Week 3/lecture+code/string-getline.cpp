...
// 01/24/2022
// The string input operator >> reads and discards any leading whitespace (spaces, newlines, tabs).
// It then reads characters until the next whitespace character is encountered. Sometimes we don't
// want to ignore the whitespace in our input. In such cases we can use the getline function
// instead of operator >> - the use of this function is illustrated in this source file.
