...
// replace "small" static arrays with functions that take an initializer_list<T>
// parameter where T indicates the "same" type of values in the initializer list. 

#include <initializer_list>
#include <iostream>

// accessing elements of initializer_list using range-for loop ...
...
// accessing elements of initializer_list using global begin() and end() functions
// that return iterators [think of them for now as pointers] to first and one-past
// last element of initializer_list, respectively ...
