...
// 01/24/2022
// The following program extracts single words from standard input and prints the
// characters of each word in reverse order. The words are separated by the
// usual whitespace (newline, space, and tab) and by commas, periods, or semicolons.
