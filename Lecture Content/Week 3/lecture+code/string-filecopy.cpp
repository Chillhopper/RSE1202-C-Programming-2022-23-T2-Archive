...
// and fstream which reads and writes a given file. These types inherit behaviors from the 
// iostream types istream, ostream, and iostream and are specialized to manage the file
// associated with the stream. This means that we can use I/O operators (<< and >>) to
// read and write files, and we can use getline to read an ifstream.
// This source file puts strings and file I/O together to write a file copy program.
// You'll need a text file to test the program.
