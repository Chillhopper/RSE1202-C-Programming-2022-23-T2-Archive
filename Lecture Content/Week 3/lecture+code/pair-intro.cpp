...
int main() {
  ...
  // direct access to the corresponding members of pair p1 is provided by an index.
  ...
  // uncomment to see compiler errors since arguments to make_pair() can only
  // be rvalues and not lvalues!!!
#if 0
  int i{12};
  double d{12.123};
