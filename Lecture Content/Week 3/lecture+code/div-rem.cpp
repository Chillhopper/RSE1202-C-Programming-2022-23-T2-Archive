...
// is returned by a value pair.

#include <iostream>
#include <utility>

// Usual way to return more than two values in C is to either use two "in/out"
// reference parameters or one "in/out" reference parameter and one function
// return value ...
...
// A 2nd overload of divide_remainder: here we return both the quotient and
// remainder as a pair of values.
...
int main() {
  // make call to have functions return multiple values using "in/out" reference parameters ...
  int q, r;
