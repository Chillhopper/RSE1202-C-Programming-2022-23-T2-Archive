...
// and is meant to illustrate the idea of extending function parameter lists
// without changing definition of the function.
...
// At a later point of time, the developer realizes that clients wish to
// render BLACK circles - so she adds a default value for this parameter
