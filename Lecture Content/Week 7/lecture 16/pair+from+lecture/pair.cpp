...
public:
  PairID() : first{}, second{} {}
  PairID(int f, double s) : first{f}, second{s} {std::cout<<"Non-template ctor\n";}
...
public:
  Pair() : first{}, second{} {}
  Pair(T1 const& f, T2 const& s) : first{f}, second{s} {std::cout<<"Template ctor\n";}
...
std::ostream&operator<<(std::ostream&os,Pair<T1,T2>const&pr)
{
